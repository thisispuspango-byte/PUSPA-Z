    ...
    <section id="galeri-agihan" className="py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-primary/10 text-primary dark:text-primary/80 border border-primary/20 backdrop-blur-md">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold shrink-0 transition-transform ${
                    isSelected ? 'bg-primary text-primary-foreground scale-105' : 'bg-muted text-foreground'
                  }`}>
                    <Icon className="h-5 w-5" />
                  </div>
                  <div>
                    <h3 className="text-sm font-bold text-foreground leading-tight">{item.title}</h3>
                    <span className="text-[11px] text-primary dark:text-primary/80 font-semibold">{item.stats}</span>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline" className="hidden sm:inline-flex bg-primary/10 text-primary dark:text-primary/80 border-primary/20 text-xs">
        ...
        <div className="rounded-3xl border border-white/10 bg-card/60 backdrop-blur-2xl p-6 sm:p-8 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border/50 pb-4">
            ...
            <Button
              ...
              size="sm"
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-xs h-9 px-4 rounded-xl gap-1.5 shadow-md active:scale-[0.97] transition-transform"
            >
            ...
            {BENEFICIARY_INSTITUTIONS.map((inst, idx) => (
              ...
              >
                <div className="flex items-start justify-between gap-1">
                  ...
                  <Badge variant="outline" className="bg-primary/10 text-primary dark:text-primary/80 border-primary/20 text-[10px] shrink-0">
                    {inst.status}
                  </Badge>
                </div>
